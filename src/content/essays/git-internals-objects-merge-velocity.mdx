...
You're reviewing a single feature, but you're wading through five commits. Half of them are debugging and reverting. Your brain burns cycles figuring out "which changes matter?" You have to re-read multiple commits to build a mental model of what the feature actually does.
